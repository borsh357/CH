...
<h2>Рассчет предварительной* стоимости ремонта</h2>
<small>*Данный калькулятор позволяет Вам рассчитать предварительную стоимость ремонта на основе параметров вашего
  помещения, материалов отделки и вида работ. Более точная стоимость ремонта высчитывается замерщиком на
  объекте. Чтобы вызвать замерщика, позвоните по номеру </small>
<div id="price-calc-container" class="price-calc-container">
  ...
  <div class="price-calc-row">
    ...
    <div class="price-calc-row-line">
      ...
      <br>
      <small>Вы можете выбрать несколько вариантов отделки, например для разных комнат или для разных зон одной
        комнаты.</small>
    </div>
